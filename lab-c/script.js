...
document.getElementById("pobierzmapa").addEventListener("click", function() {
    ...
    leafletImage(map, function(err, canvas) {
        ...
        const img = document.getElementById('map-section');
...
function splitImage(canvas) {
    ...
    const assemblyArea = document.getElementById("area");
...
function checkIfComplete() {
    const pieces = Array.from(document.querySelectorAll("#area .puzzle-piece"));
